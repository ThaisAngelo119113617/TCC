...
#ifndef AS2_MSGS__ACTION__DETAIL__GRIPPER_HANDLER__TYPE_SUPPORT_H_
#define AS2_MSGS__ACTION__DETAIL__GRIPPER_HANDLER__TYPE_SUPPORT_H_
...
#endif  // AS2_MSGS__ACTION__DETAIL__GRIPPER_HANDLER__TYPE_SUPPORT_H_
