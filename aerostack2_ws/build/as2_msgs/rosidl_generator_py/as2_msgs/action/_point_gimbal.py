...
class Metaclass_PointGimbal_Goal(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'POINT_MODE': cls.__constants['POINT_MODE'],
            'MOVE_MODE': cls.__constants['MOVE_MODE'],
        }

    @property
    def POINT_MODE(self):
        """Message constant 'POINT_MODE'."""
        return Metaclass_PointGimbal_Goal.__constants['POINT_MODE']

    @property
    def MOVE_MODE(self):
        """Message constant 'MOVE_MODE'."""
        return Metaclass_PointGimbal_Goal.__constants['MOVE_MODE']
