...
struct PointGimbal_Goal_
{
  ...
  static constexpr uint8_t POINT_MODE =
    0u;
  static constexpr uint8_t MOVE_MODE =
    1u;
...
constexpr uint8_t PointGimbal_Goal_<ContainerAllocator>::POINT_MODE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t PointGimbal_Goal_<ContainerAllocator>::MOVE_MODE;
#endif  // __cplusplus < 201703L
