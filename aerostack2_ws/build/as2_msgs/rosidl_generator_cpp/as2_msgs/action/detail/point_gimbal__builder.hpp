...
class Init_PointGimbal_Goal_mode
{
public:
  explicit Init_PointGimbal_Goal_mode(::as2_msgs::action::PointGimbal_Goal & msg)
  : msg_(msg)
  {}
  ::as2_msgs::action::PointGimbal_Goal mode(::as2_msgs::action::PointGimbal_Goal::_mode_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_PointGimbal_Goal_mode follow_mode(::as2_msgs::action::PointGimbal_Goal::_follow_mode_type arg)
  {
    msg_.follow_mode = std::move(arg);
    return Init_PointGimbal_Goal_mode(msg_);
  }
